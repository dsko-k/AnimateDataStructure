namespace AnimateDataStructure.Web.Constants
{
    public static class ViewDataKeys
    {
        ...
        public const string ActionNameTraverseInorder = nameof(ActionNameTraverseInorder );
        public const string ActionNameTraversePreorder = nameof(ActionNameTraversePreorder );
        public const string ActionNameTraversePostorder = nameof(ActionNameTraversePostorder );
        public const string ActionNameSaveNodes = nameof(ActionNameSaveNodes);
    }
}
