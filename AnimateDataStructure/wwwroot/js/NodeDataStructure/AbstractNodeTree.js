...
export class AbstractNodeTree // functionality of binary tree
{
    constructor(value)
    {
        ...
        this.wasChangedNodeColorAfterVisiting = false; // was color of node changed after this node was visited
    ...
    {
        this.nodeId = `orderNumber_${nodeOrderNumber}`; // was: this.nodeId = `nodeValue_${nodeValue}_orderNumber_${nodeOrderNumber}`;
    }
}