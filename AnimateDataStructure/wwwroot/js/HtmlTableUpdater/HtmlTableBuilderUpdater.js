...
export class HtmlTableBuilderUpdater // Builder
{
    ...
    {
        this.updateStyleTextAndContentInCell(idTable, statusForCell); // updating cell with text and text if text need to be updated        
        this.updateStyleCellLoader(idTable, statusForCell, isCellLoaderSequentiallyOn); // updating cell loader
    }
    ...
    updateStyleCellLoader(idTable, statusForCell, isCellLoaderSequentiallyOn)
    {
        ...
        // add handler to remove additional style in div related with cellLoader after ending animation of cellLoader
    ...
    {
        let tableSearching = new TableSearching(idTable, null);
