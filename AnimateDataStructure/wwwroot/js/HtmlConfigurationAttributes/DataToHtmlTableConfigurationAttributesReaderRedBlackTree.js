export class DataToHtmlTableConfigurationAttributesReaderRedBlackTree
{
    ...
    getDataTableToHtmlTableConfigurationsForTreeCharacteristics(dataStructure)
    {
        const dataToHtmlTableAttributes = {
            ...
            tableTitle: "Red-Black Tree Characteristics",
    ...
    getDataTableToHtmlTableConfigurationsForTreeOperations(dataStructure)
    {
        const dataToHtmlTableAttributes = {
            ...
            tableTitle: "Operations in Red-Black Tree",
    ...
    getDataTableToHtmlTableConfigurationsForTreeTraversing(dataStructure)
    {
        const dataToHtmlTableAttributes = {
            ...
            tableTitle: "Traversing Red-Black Tree",
        ...
        const dataToHtmlTableAttributes = {
            ...
            configureTableRowsObject()
            {
                ...
                return {
                    ...
                    row9: {
                        column1: this.dataStructureFieldsTitlesAttributes.isNodeRed,
                        column2: nodeThatWasClickedLastTime.isNodeRed,
                    },
                };
            },
        };
