export class HtmlConfigurationAttributesReader // Home
{
    ...
    // It is not the same as sidebar's table, but functionality the same
    getHistoryTableConfigurations()
    {
        const allAttributes = {

            // NOTE: here attribute style="width: 75%;" is needed as hardcode
        ...
        const allAttributes = {
            ...
            inputAttributes: {
                ...
                defaultAttributes: {
                    ...
                    "class": "input",
                    "placeholder": "", // placeholder="" it is needed for label input CSS effects
                    "type": "text",
                },
                textInsideInput: {
                    "whenInputDisabled": "", // placeholder="" it is needed for label input CSS effects
                    "whenInputEnabled": "",// placeholder="" it is needed for label input CSS effects
                },
            },
    ...
    getHtmlControlButtonFindNodeConfigurations()
    {
        const allAttributes = {
            ...
            buttonFindNodeAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonFindOnMouseDown", // style is applied to input container not for button
                },
            },
        };
    ...
    getHtmlControlButtonDeleteNodeConfigurations()
    {
        const allAttributes = {
            ...
            buttonDeleteNodeAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonDeleteOnMouseDown", // style is applied to input container not for button
                },
            },
        };
    ...
    getHtmlControlButtonTraverseMenuConfigurations()
    {
        const allAttributes = {
            ...
            buttonTraverseMenuAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonTraverseMenuOnMouseDown", // style is applied to input container not for button
                },
                textInsideButton: {
    ...
    getHtmlControlListOfTraverseMenuConfigurations()
    {
        const allAttributes = {
            ...
            listOfTraverseMenuAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "showListOfTraversalMenu", // style is applied to input container not for button
                },
            },
        };
    ...
    getHtmlControlButtonTraverseInorderConfigurations()
    {
        const allAttributes = {
            ...
            buttonTraverseInorderAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonTraverseInorderOnMouseDown", // style is applied to input container not for button
                },
            },
        };
    ...
    getHtmlControlButtonTraversePreorderConfigurations()
    {
        const allAttributes = {
            ...
            buttonTraversePreorderAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonTraversePreorderOnMouseDown", // style is applied to input container not for button
                },
            },
        };
    ...
    getHtmlControlButtonSaveConfigurations()
    {
        const allAttributes = {
            ...
            buttonSaveAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonSaveOnMouseDown", // style is applied to input container not for button
                },
    ...
    getHtmlControlButtonLogInConfigurations()
    {
        const allAttributes = {
            ...
            buttonLogInAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonLogInOnMouseDown", // style is applied to input container not for button
                },
            },
        };
    ...
    getHtmlControlButtonAuthenticateConfigurations()
    {
        const allAttributes = {
            ...
            buttonAuthenticateAttributes: {
                ...
                dataAttributeNames: {
                    dataAttributeNameForIdButtonToClickAfterAuthentication: "idButtonToClickAfterAuthentication",// data- skipped
                }
            },
        };
    ...
    getAuthenticationFormsDatastructuresConfigurations()
    {
        const allAttributes = {
            ...
            // This tag and its style should be inserted on the page that should be extended with Authentication
            ...
            buttonSubmitSignUpFormAttributes: {
                ...
                onMouseDownAttributes: {
                    "class": "neonButtonSignUpOnMouseDown", // style is applied to input container not for button
                },
