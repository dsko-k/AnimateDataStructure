export class HtmlPageDomUpdater
{
    ...
    getChildrenDomElementsByParentIdAndChildrenTag(parentId, childrenTagName)
    {
        ...
        //let foundChildren = parentDomElement.querySelector(childrenTagName);
    ...
    {
        //this.throwExceptionIfCssKeyNameIsIncorrect(cssKeyName)
    ...
    updateLastAdditionalStyleName(domElement, newAdditionalStyleName)
    {
        ...
        //domElement.classList.toggle(lastStyleName); // remove current last style
    ...
    // does class contains specified style among additional styles
