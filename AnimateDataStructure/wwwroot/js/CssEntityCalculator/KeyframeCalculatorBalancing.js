...
export class KeyframeCalculatorBalancing extends AbstractCssEntityCalculator // ConcreteStrategyC
{
    ...
    calculateEntityName(isForNodeToAnimate)
    {
        ...
        {
            return this.keyframePrototypeName + "_Balancing_" + this.tree.balancedTimes + "_" + super.nodeIdentifierName(false); // return this.getKeyframePrototypeName() + "_" + super.nodeIdentifierName(false);
        }

        return this.keyframePrototypeName + "_Balancing_" + this.tree.balancedTimes + "_" + super.nodeIdentifierName(true); // return this.getKeyframePrototypeName() + "_" + super.nodeIdentifierName(true);
    }
