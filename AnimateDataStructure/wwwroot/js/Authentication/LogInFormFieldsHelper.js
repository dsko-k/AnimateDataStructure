...
export class LogInFormFieldsHelper extends AbstractFormFieldsHelper
{
    constructor()
    {
        ...
        this.idForm = this.formLogInConfig.defaultAttributes.id; // added
        ...
        this.registerLink = this.htmlPageDomUpdater.getDomElementOnPageById(this.registerLinkConfig.defaultAttributes.id); //elements.registerLink;
    }
    ...
    getFormMapErrorDomElements(logInFormDomElements)
    {
        const errorElementMap = {
            ...
            //General: logInFormDomElements.generalSignUpError // If there is a general error span
        };
